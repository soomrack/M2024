...
const int years = 30;
const int years_no_job = 4;
const int month_tunejad = 3;
const int years_reparation = 2;

const int years_before_yacht = 3;
const int years_maintence_yacht = 2;  // обслуживание яхты
const int years_after_yacht = years - years_before_yacht - years_maintence_yacht;
const Shekel price_yacht = 300000 * 100;
const Shekel yacht_maintenance = 30000 * 100;

const double deposite = 16;
const double flat_rate = 18;
const double indexation = 12;
...
void Bob_buy_yacht()
{
    Bob.balance -= price_yacht;
}
void Bob_maintence_yacht()
{
